...
//data structure to hold multiple values is called an "array".
...
var arr2 = ["Moyeen", "English", 1, true, null];
console.log(arr2);
...
//access the first element of the first element of the array = 1
